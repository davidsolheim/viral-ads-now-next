    ...
    <div className="bg-white">
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
              <p className="text-xs font-semibold uppercase text-blue-600">Video walkthrough</p>
              <div className="mt-4 flex h-56 items-center justify-center rounded-xl border border-dashed border-blue-200 bg-blue-50 text-sm text-blue-700">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6">
              <p className="text-xs font-semibold uppercase text-blue-600">What you get</p>
      ...
      <section className="bg-gray-50">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900">Ready to automate your TikTok ads?</h2>
